<div class="accordion" id="adminMenu">
    <div class="menu-group">
        <div class="menu-title" id="headingOne">
            <div class="mb-0 py-2 border-bottom" data-toggle="collapse" data-target="#a0">
    ...
    <div class="menu-group">
        <div class="menu-title" id="headingTwo">
            <div class="mb-0 py-2 border-bottom" data-toggle="collapse" data-target="#a1">
    ...
    <div class="menu-group">
        <div class="menu-title" id="headingThree">
            <div class="mb-0 py-2 border-bottom" data-toggle="collapse" data-target="#a2">
    ...
    <div class="menu-group">
        <div class="menu-title" id="headingThree">
            <div class="mb-0 py-2 border-bottom" data-toggle="collapse" data-target="#a3">
